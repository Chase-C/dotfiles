...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>fa"] = {
    function()
      ...
      local search_dirs = {}
      for _, dir in ipairs(sushi.supported_configs) do -- search all supported config locations
        if dir == sushi.install.home then dir = dir .. "/lua/user" end -- don't search the astronvim core files
